...
def main() -> int:
    ...
    p.add_argument(
        ...
        default="azure-storage-fmarichub-access-key",
        metavar="SECRET",
        help="Key Vault secret name for storage key (default: azure-storage-fmarichub-access-key)",
    )
    p.add_argument(
    ...
    result = {"base_url": base, "flat_dir": args.flat_dir}
