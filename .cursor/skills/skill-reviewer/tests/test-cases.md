...
| 4 | "After you review the skill, save the report to `tests/results/` and append `history.json`." | Agent cites Step 6–7: `review-<skill>-<RUN_SLUG>.md`, **`reviewed_at`** in history, benchmark `.md`/`.html` with matching slug, snapshot in **7d**. |
