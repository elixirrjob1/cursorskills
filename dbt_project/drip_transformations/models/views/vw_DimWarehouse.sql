...
SELECT
    CAST(SHA2(COALESCE(CAST(warehouse_code AS VARCHAR), '#@#@#@#@#'), 256) AS BINARY(32)) AS WarehouseHashPK,
    CAST(SHA2(COALESCE(CAST(warehouse_code AS VARCHAR), '#@#@#@#@#'), 256) AS BINARY(32)) AS WarehouseHashBK,
